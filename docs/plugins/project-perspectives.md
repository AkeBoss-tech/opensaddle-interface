...
Remaining: native desktop verification and lifecycle integration, bounded live
revocation refresh, authoring scaffolds, richer conversation projections, state
