...
export type JourneySnapshot = {
  ...
  activeRuns?: Array<{ runId: string; task: string; status: string; requestedBy: string; cancellationRequested: boolean; nativeAdapterId?: NativeAdapterId; nativeModel?: string }>
...
export interface JourneyAuthority {
  ...
  delegate?(projectId: string, sourceId: string, task: string, nativeAdapterId?: NativeAdapterId, authorizedContextSourceIds?: string[]): Promise<unknown>
