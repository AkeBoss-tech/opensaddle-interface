...
export function ConnectedLocalSettingsPage() {
  ...
  return <div className="content-page connected-local-page">
    <header className="page-header"><div><span className="eyebrow">Connection settings</span><h1>Local OpenSaddle server</h1><p>Connected-local mode exposes only server-advertised capabilities.</p></div><Button variant="secondary" onClick={() => navigate('/home')}>Open Command Center</Button></header>
