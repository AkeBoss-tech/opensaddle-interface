...
export function CommandCenterSurface({client,connected,identity,projects}:{client?:CommandCenterClient;connected:boolean;identity:object;projects:Array<{id:string;name:string}>}) {
