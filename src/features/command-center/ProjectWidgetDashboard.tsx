...
export function ProjectWidgetDashboard({client,identity,widgets,directory,shell,journey,stateScope}:{client?:DashboardSettings;identity:unknown;widgets:DashboardWidget[];directory?:Pick<ProjectDirectoryClient,'list'>;shell?:MalleableShellClient;journey?:Pick<JourneyAuthority,'snapshot'>;stateScope?:string}){
