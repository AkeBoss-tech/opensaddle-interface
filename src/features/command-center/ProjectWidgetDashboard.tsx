...
export function ProjectWidgetDashboard({client,identity,widgets,directory,shell,journey,stateScope,taskFeed,rendererSettings}:{rendererSettings?:RendererSettingsAuthority;taskFeed?:ProjectTaskFeedAuthority;client?:DashboardSettings;identity:unknown;widgets:DashboardWidget[];directory?:Pick<ProjectDirectoryClient,'list'>;shell?:MalleableShellClient;journey?:Pick<JourneyAuthority,'snapshot'>;stateScope?:string}){
