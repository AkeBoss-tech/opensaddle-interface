...
export function projectViewCompatibility(renderer:ApplicationRendererDescriptor):string|undefined{
 ...
 if(value.mount_kind!=='perspective'||value.scope!=='project')return 'This package does not provide a Project Perspective.'
