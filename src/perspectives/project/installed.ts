...
const HOST_API=1
const HOST_CAPABILITIES=new Set(['projection.project-runs.v1','projection.live.v1','navigation.task.open.v1','navigation.task.create.v1','read.project-sources.v1','read.project-devices.v1'])
