...
export function RunsPage() {
  ...
  if (runId && services?.controlPlane.v2Capabilities) {
    ...
    return <AuthoritativeRunSurface authority={journey as typeof journey & {runDetail:NonNullable<typeof journey.runDetail>}} runId={runId} codingResults={services.codingResults} agentResultReview={services.agentResultReview} hostedAgentResultReview={services.hostedAgentResultReview}/>
  }
